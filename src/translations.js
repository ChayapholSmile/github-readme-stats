...
const statCardLocales = ({ name, apostrophe }) => {
  ...
  return {
    ...
    "statcard.prs": {
      ...
      vi: "Tổng Số PR",
      se: "Totalt antal PR",
      th: "จำนวนการส่ง Pull Requests ทั้งหมด",
    },
    "statcard.issues": {
      ar: "مجموع التحسينات",
      cn: "指出问题数（issue）",
    ...
    "statcard.contribs": {
      ...
      th: "ให้การช่วยเหลือผู้อื่นจำนวน (ปีที่แล้ว)",
    },
    "statcard.reviews": {
      ...
      th: "จำนวน Pull Requests ที่ได้รับการตรวจสอบแล้ว",
    },
    ...
    "statcard.discussions-answered": {
      ...
      th: "จำนวนการพูดคุยที่ได้รับการตอบแล้ว",
    },
    "statcard.prs-merged": {
      ...
      th: "จำนวน Pull Requests ที่ได้รับการผูก",
    },
    "statcard.prs-merged-percentage": {
      ...
      th: "เปอร์เซ็นต์จำนวนการผูก Pull Requests",
    },
  };
};
...
const wakatimeCardLocales = {
  ...
  "wakatimecard.notpublic": {
    ...
    th: "โปรไฟล์ผู้ใช้ WakaTime ไม่เป็นสาธารณะ",
  },
  "wakatimecard.nocodedetails": {
    ...
    th: "ผู้ใช้ไม่แบ่งปันสถิติโค้ดโดยละเอียดต่อสาธารณะ",
  },
